      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 bg-[#3390d5] text-white text-sm sm:text-base font-medium rounded-md hover:bg-[#3390d5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
              Update Password
            </button>
          </form>
