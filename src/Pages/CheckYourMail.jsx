  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white p-4 sm:p-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 sm:p-8 text-center">
          ...
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="bg-blue-100 p-3 sm:p-4 rounded-full">
              <FiMail className="text-[#378CCC] text-3xl sm:text-4xl" />
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-3 sm:space-y-4">
            <Link
              to="/signin"
              className="w-full py-2 sm:py-3 px-4 bg-[#378CCC] text-white text-sm sm:text-base font-medium rounded-lg hover:bg-[#378CCC] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-center transition-colors"
            >
              Back to Sign In
            </Link>
            ...
            <p className="text-xs sm:text-sm text-gray-500">
              ...
              <button className="text-[#378CCC] hover:text-[#378CCC] font-medium focus:outline-none">
                Resend
              </button>
            </p>
          </div>
      ...
      <div className="mt-8 sm:mt-12 text-center text-xs sm:text-sm text-gray-500">
        Need help? <Link to="/contact" className="text-[#378CCC] hover:text-[#378CCC]">Contact support</Link>
      </div>
    </div>
  );
};
