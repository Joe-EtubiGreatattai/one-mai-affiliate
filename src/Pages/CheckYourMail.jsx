      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white rounded-xl shadow-md p-6 sm:p-8 text-center">
          ...
          <div className="flex flex-col space-y-3 sm:space-y-4">
            <Link
              to="/signin"
              className="w-full py-2 sm:py-3 px-4 bg-[#3390d5] text-white text-sm sm:text-base font-medium rounded-lg hover:bg-[#3390d5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-center transition-colors"
            >
              Back to Sign In
            </Link>
